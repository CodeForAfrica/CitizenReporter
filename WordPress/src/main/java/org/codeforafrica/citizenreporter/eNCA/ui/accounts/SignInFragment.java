...
import org.codeforafrica.citizenreporter.eNCA.ui.accounts.helpers.FetchBlogListAbstract.Callback;
import org.codeforafrica.citizenreporter.eNCA.ui.accounts.helpers.FetchBlogListWPCom;
import org.codeforafrica.citizenreporter.eNCA.ui.accounts.helpers.FetchBlogListWPOrg;
import org.codeforafrica.citizenreporter.eNCA.ui.accounts.helpers.LoginAbstract;
import org.codeforafrica.citizenreporter.eNCA.ui.accounts.helpers.LoginWPCom;
...
public class SignInFragment extends AbstractFragment implements TextWatcher {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mUrlEditText.setText(org.codeforafrica.citizenreporter.eNCA.BuildConfig.DEFAULT_URL);
        //autofill sign in details if app is in debug mode
        if (BuildConfig.IS_DEMO_APP.equals("1")) {
            mUsernameEditText.setText(org.codeforafrica.citizenreporter.eNCA.BuildConfig.DEFAULT_USERNAME);
            mPasswordEditText.setText(org.codeforafrica.citizenreporter.eNCA.BuildConfig.DEFAULT_PASSWORD);
        }
