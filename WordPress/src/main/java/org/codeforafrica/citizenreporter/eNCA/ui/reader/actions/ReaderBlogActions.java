...
import org.codeforafrica.citizenreporter.eNCA.ui.reader.actions.ReaderActions.UpdateBlogInfoListener;
...
public class ReaderBlogActions {
    ...
    public static void updateBlogInfo(long blogId,
        ...
        if (hasBlogId) {
            ...
            WordPress.getRestClientUtilsV1_1().get("sites/" + UrlUtils.urlEncode(UrlUtils.getHost(blogUrl)), listener, errorListener);
        }
    }
